...
<div class="register-main">
    ...
    <div class="register-box">
        ...
        <form name="registerForm" method="post" action="form2.php">
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="phpName"> <strong>Name</strong> </label>
                    <input type="text" class="form-control focus validate" name="name" id="phpName" maxlength=20 placeholder="Full Name">
            ...
            <button type="button" class="btn btn-sm btn-outline-success" id="submitBtn" name="submit">Submit</button>
        </form>
